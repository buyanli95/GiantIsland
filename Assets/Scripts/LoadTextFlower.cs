...
public class LoadTextFlower : MonoBehaviour {
    ...
    void treeBirdEffect()
    {
        ...
        {
            TextRoot.transform.Find("Spot-Tree-Bird").gameObject.SetActive(true);
    ...
    void backToFrontText()
    {
        if (OVRInput.GetUp(OVRInput.Button.PrimaryIndexTrigger))
        {
            ...
            preText.GetComponent<LoadTextGrass>().rollBackCheck(1);
        }
    }
